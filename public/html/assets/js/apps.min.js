...
jQuery(document).ready(function($) {
    ...
    jQuery('a.scrollLink[href*="#"]:not([href="#"])').click(function() {
        if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') && location.hostname == this.hostname) {
            ...
            if (target.length) {
                jQuery('html, body').animate({ scrollTop: $($(this).attr("href")).offset().top }, 500);
                return false;
            }
        }
    });
    ...
    $("#sale-range-feet").ionRangeSlider({
        ...
        onChange: function(data) {
            $('#acreage_from').val(data.from);
            $('#acreage_to').val(data.to);
        }
    }),
    ...
    $("#sale-range-feet-1").ionRangeSlider({
        ...
        prefix: "",
        onChange: function(data) {
            $('#acreage_from1').val(data.from);
            $('#acreage_to1').val(data.to);
        }
    })
});