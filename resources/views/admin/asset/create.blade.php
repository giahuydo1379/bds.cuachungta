                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            {!! Form::select("province_id", $province, null, ['id' => 'province_id', 'class' => 'form-control select2 province_id ','data-placeholder' => '--- Chọn tỉnh/thành phố ---']) !!}
                        ...
                        <label class="col-sm-2 control-label" for="form-field-1">
                                    ...
                                    <div class="col-sm-5">
                                        {!! Form::select('asset_category_id', $category, null, [
                                                'id' => 'category',
                                                'class' => 'form-control select2',
