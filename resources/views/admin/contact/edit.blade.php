                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="radio-inline">
                                            <input type="radio" name="status" id="status1" value="1" <?=$object['is_deleted']=='0'?'checked':''?>> Hiển thị
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" id="status2" value="0" <?=$object['is_deleted']=='1'?'checked':''?>> Không hiển thị
                                        </label>
                                    </div>
                                </div>
