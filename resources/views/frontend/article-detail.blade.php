            ...
            <div class="col-lg-9 order-lg-9">
                <div class="product-detail">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h4 class="product-detail-name">{{ $object['name'] }}</h4>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                @foreach($products_same_code as $item)
                                    <tr>
                                        <th class="text-nowrap table-msp"><?=$item['name']?></th>
                                        <td><?=$item['short_description']?></td>
                                        <td class="d-none"><?=number_format($item['price'])?></td>
                                        <td class="text-right"><?=$item['amount']??'Liên hệ'?></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                                    ...
                                    <div class="card-body d-flex">
                                        <a href="<?=route('article_detail', ['article_slug' => str_slug($item['name']), 'id' => $item['id']])?>"
                                           class="align-self-center mx-auto">
                                            <img class="img-fluid" alt="{{ $item['name'] }}" src="{{ $item['image'] }}">
                                        </a>
                                    </div>
