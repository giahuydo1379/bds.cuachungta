...
<li><a href="{{backpack_url('asset-category') }}"><i class="fa fa-list"></i> <span>QL Danh mục sản phẩm</span></a></li>
<li><a href="{{backpack_url('support') }}"><i class="fa fa-list"></i> <span>QL Hỗ trợ tực tuyến</span></a></li>
<li><a href="{{backpack_url('contact') }}"><i class="fa fa-list"></i> <span>Danh sách yêu cầu liên hệ</span></a></li>
